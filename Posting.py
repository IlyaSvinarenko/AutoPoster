...
def fansly_open(l: list, hours: int):
    ...
    try:
        ...
        print("////////////////   Произошла ошибка в fansly_open   //////////////")
...
def posting_cycle(l, browser, hours):
    ...
    try:
        for i in l:
            ...
            trash_button = browser.find_element("xpath",
                                                "/html/body/app-root/div/div[3]/app-account-media-upload/div/div["
            ...
            print(f'count_of_complete_posts = {count_of_complete_posts}')
            sleep(4)
        browser.quit()
        count_of_complete_posts = 0
    except:
